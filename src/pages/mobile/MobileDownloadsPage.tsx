 ...
 * không lưu file nào cả). Làm giả 1 danh sách "đã tải" ở đây sẽ đánh lừa bố mẹ/bé tưởng có
 * thể xem offline thật — không được phép theo yêu cầu gốc (không hard-code/giả dữ liệu) lẫn
 * theo UI_SPEC.md mục 8 ("Show only genuinely supported offline content. Do not fake YouTube
 * downloads."). Giữ tab này trong menu (đúng theo bản đặc tả) để dành chỗ cho sau này, nếu
 * app có hỗ trợ tải nội dung trực tiếp (mp4/HLS) thật sự.
 */
